...
//            httpPost.setConfig(requestConfig);
            ...
            LOGGER.error("Http post io exception",e);
            throw e;
        } finally {
            if (response != null) {
                try {
        ...
        LOGGER.info("结束HttpUtil.post ,当前时间戳:{},用时:{}",endTime,(endTime-startTime));
        return httpStr;
    }
...
//            httpPost.setConfig(requestConfig);
    ...
    public static String doPost(CloseableHttpClient httpClient,String apiUrl, Map<String, Object> params, String text) {
        ...
        try {
            for (Map.Entry<String, Object> entry : params.entrySet()) {
                httpPost.setHeader(entry.getKey(), entry.getKey().toString());
            }
