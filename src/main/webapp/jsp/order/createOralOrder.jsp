					...
					<ul class="mb-40">
						<li class="none-ml">
							...
							<p class="int-posit"><input id="begin_time" name="begin_time" type="text" class="int-text int-in-250 radius"
                                      onClick="WdatePicker({onpicked: function(){$dp.$('begin_time').blur();},lang:'${my97Lang}',isShowOK:true,autoPickDate:true, dateFmt:'yyyy-MM-dd HH:mm:ss',minDate:'%y-%M-%d %H:%m:%s',maxDate:'#F{$dp.$D(\'end_time\',{m:-1})}'})"
						...
						<li>
							...
							<p class="int-posit"><input id="end_time" name="end_time" type="text" class="int-text int-in-250 radius"
                                      onClick="WdatePicker({onpicked: function(){$dp.$('begin_time').blur();},lang:'${my97Lang}',isShowOK:true,autoPickDate:true, dateFmt:'yyyy-MM-dd HH:mm:ss',minDate:'#F{$dp.$D(\'begin_time\',{m:+1})||\'%y-%M-%d %H:{%m+2}:%s\'}'})"
