                ...
                <div class="right-title-left user-account-title">
                    <div class="right-title-left-word user-account-title-word">
                        ...
                        <ul>
                            ...
                            <li class="c-bj-bule"><a href="${_base}/p/companybalance/depositCompanyFund"><spring:message code="account.recharge"/></a></li>
                            <% } %>
                        </ul>
                        <ul class="word-li">
