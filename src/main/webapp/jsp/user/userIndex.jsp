    ...
    <div class="right-list" id="no_order_container" style="display: none;">
			...
			<div class="no-order">
				<ul>
					...
					<li class="right mt-t50"><input onclick="location.href='${_base}/written'" type="button"  class="btn border-blue btn-large radius20 blue" value="<spring:message code="home.manual_order_now_btn"/>"></li>
				</ul>
			</div>
			<div class="no-step">
			<ul>
	...
	<tr>
 		<th order_mode_colspan="hide" colspan="5" class="text-l">
 			<div class="table-thdiv">
				...
				<p name="orderId" style="cursor:pointer;"><span class="ash-color"><spring:message code="myOrder.Ordernumber"/>：</span><span><a href="javaScript:void(0);">{{:orderId}}</a></span></p>
				{{if  displayFlag == '11'}}
				<!-- 剩余2天23小时59分钟  待支付-->
