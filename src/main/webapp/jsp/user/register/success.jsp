			...
			<div class="register-right radius">
				...
				<div class="verification">
					<ul>
						...
						<li class="word"><spring:message
								code="ycregister.registerSuccessMsg1" /></li>
						<li><spring:message code="ycregister.registerSuccessMsg2" /></li>
						<li><spring:message code="ycregister.registerSuccessMsg3" /></li>
					</ul>
				</div>
