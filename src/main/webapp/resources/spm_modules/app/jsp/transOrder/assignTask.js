define('app/jsp/transOrder/assignTask', function (require, exports, module) {
    'use strict';
    var $=require('jquery'),
    ...
    var assignTaskPage = Widget.extend({
    	//属性，使用时由类的构造函数传入
    	attrs: {
    		clickId:""
    	},
    	...
    	events: {
      	...
      	//重写父类
    	setup: function () {
            assignTaskPage.superclass.setup.call(this);
			//初始化国际化
...
//	 			 $('#orderQuery').serialize()
	 			data: data,
	           	pageSize: assignTaskPage.DEFAULT_PAGE_SIZE,
	           	visiblePages:5,
